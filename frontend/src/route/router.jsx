...
// import NewPasswordcreative from "../pages/newPassword-creative";
...
// import EditCustomer from "@/components/customersView/EditCustomer";
...
//             { path: "/customers/view/:id", element: <CustomersView /> }, // i am adding this route for specific user detail show regrading
...
//             { path: "/authentication/newPassword/creative", element: <NewPasswordcreative /> },
...
import ChangePassword from "@/components/authentication/ChangePasswordForm";


export const router = createBrowserRouter([

    /*
        DASHBOARD ROUTE (Admin + Customer Access)
       Only Home page is accessible by both roles*/
    {
        path: "/",
        element: (
            <ProtectedRoute allowedRoles={["admin", "customer"]}>
        ...
        children: [
            { path: "/", element: <Home /> }, // Dashboard page
        ],
    },


    //  ADMIN ONLY ROUTES (Customers, Payments, Projects etc.)
    //    Customer cannot access these routes
    {
        path: "/",
        element: (
        ...
        children: [
            ...
            { path: "/customers/list", element: <CustomersList /> },
            { path: "/customers/view", element: <CustomersView /> },
            { path: "/customers/view/:id", element: <CustomersView /> },
            { path: "/customers/create", element: <CustomersCreate /> },
            { path: "/customers/edit/:id", element: <EditCustomer /> },
            ...
            { path: "/leads/view", element: <LeadsView /> },
            { path: "/leads/create", element: <LeadsCreate /> },
            { path: "/leads/edit/:id", element: <EditLeads /> },
    ...
    // AUTH ROUTES (Public - No Login Required)
    {
        ...
        children: [
            ...
            { path: "/authentication/reset/creative", element: <ResetCreative /> },
            { path: "/authentication/newPassword/creative", element: <NewPasswordcreative /> },
            { path: "/authentication/changepassword/creative", element: <ChangePassword /> },
            { path: "/authentication/verify/creative", element: <OtpCreative /> },
            { path: "/authentication/404/creative", element: <ErrorCreative /> },
        ],
    },
