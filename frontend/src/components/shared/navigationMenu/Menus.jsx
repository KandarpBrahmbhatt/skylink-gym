            ...
            {filteredMenu.map(({ dropdownMenu, id, name, path, icon }) => {
                return (
                    ...
                    >
                        ...
                        {dropdownMenu?.length > 0 && (
                            <ul
                                className={`nxl-submenu ${openDropdown === name
                                    ? "nxl-menu-visible"
                                    : "nxl-menu-hidden"
                                    }`}
                            >
                                    ...
                                    ({ id, name, path, subdropdownMenu }) => {
                                        ...
                                        return (
                                            <Fragment key={id}>
                                                {subdropdownMenu?.length ? (
                                                    <li
                                                        className={`nxl-item nxl-hasmenu ${activeChild === name
                                                            ? "active"
                                                            : ""
                                                            }`}
                                                        onClick={(e) =>
                                                    ...
                                                    >
                                                        ...
                                                        {subdropdownMenu.map(
                                                            ({
                                                                ...
                                                                <ul
                                                                    key={id}
                                                                    className={`nxl-submenu ${openSubDropdown ===
                                                                        x
                                                                        ? "nxl-menu-visible"
                                                                        : "nxl-menu-hidden"
                                                                        }`}
                                                    ...
                                                    <li
                                                        className={`nxl-item ${pathName === path
                                                            ? "active"
                                                            : ""
                                                            }`}
                                                    >
