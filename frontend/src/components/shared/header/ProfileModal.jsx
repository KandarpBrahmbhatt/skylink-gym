        ...
        <div className="dropdown nxl-h-item">
            ...
            <div className="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                ...
                <button
                    ...
                    className="dropdown-item border-0 bg-transparent text-start"
                >
...
const getColor = (item) => {
    switch (item) {
        case "Always": return "always_clr"
        case "Bussy": return "bussy_clr"
        case "Inactive": return "inactive_clr"
        case "Disabled": return "disabled_clr"
        case "Cutomization": return "cutomization_clr"
        default: return "active-clr"
    }
}